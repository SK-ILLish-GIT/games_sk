...
export const config = {
  ...
  game: {
    id:            'flappy-bird',
    stateTtl:      parseInt(process.env.GAME_STATE_TTL || '3600', 10), // seconds
    dailySeedTtl:  parseInt(process.env.DAILY_SEED_TTL || '86400', 10), // seconds
    httpTimeoutMs: parseInt(process.env.HTTP_TIMEOUT_MS || '3000', 10),
    runMaxDurationSec: parseInt(process.env.RUN_MAX_DURATION_SEC || '900', 10), // hard cap: 15 min
  },
};
